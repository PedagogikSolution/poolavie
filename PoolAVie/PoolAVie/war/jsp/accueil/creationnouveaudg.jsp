					...
					<form class="w3-container w3-padding-left" action="/CreationDirecteurGeneral" method="post" name="creation">
						<div class="w3-half w3-container ">
							...
							<div class="w3-card-24 w3-white" style="width: 55%; height: 55%; margin-left: auto; margin-right: auto">
								...
								<br>
								<input class="w3-padding-left w3-padding-right w3-input w3-text-indigo w3-container w3-validate w3-margin-left" type="email" name="email" style="width: 90%">
								<br>
								<label class="w3-label w3-container w3-text-indigo w3-large">Nom d'utilisateur</label>
								<br>
								<input class="w3-padding-left w3-padding-right w3-input w3-text-indigo w3-container w3-validate w3-margin-left" type="text" name="username" style="width: 90%">
								<br>
								<label class="w3-label w3-container w3-text-indigo w3-large">Mot de passe</label>
								<br>
								<input class="w3-padding-left w3-padding-right w3-input w3-text-indigo w3-container w3-validate w3-margin-left" type="password" name="password" style="width: 90%">
								<br>
								<br>
