...
<body>
	...
	<hr class="hr_header">
	<div class="main_menu">
		<a href="/jsp/main/main.jsp"><button class="btn_menu">Classement</button></a> <a href="/draft?sortby=all"><button class="btn_menu">Draft</button></a> <a href="/trade"><button class="btn_menu">Trade</button></a>
	...
	<div class="main_container">
		<div class="main_content">
			<div id="main_content_title_classement">LA LISTE DE MES OFFRES</div>
			...
			<div id="main_content_table_classement">
				...
				<c:if test="${messageErreur.codeErreurOffreTrade==7}">
					<h1 style="color: red">
						<strong>Les 2 équipes ne peuvent pas donner de l'argent. Reglement 3.2</strong>
					</h1>
				</c:if>

				<c:if test="${messageErreur.codeErreurOffreTrade==8}">
					<h1 style="color: red">
						<strong>Au moins une des 2 équipes doient avoir un joueur impliqué, sinon il s'agit d'Argent contre pick qui n'est possible que lors du draft. Reglement 4.2</strong>
					</h1>
				</c:if>

				<c:if test="${messageErreur.codeErreurOffreTrade==9}">
					<h1 style="color: red">
						<strong>Vous devez inclure un maximum de 7 joueurs provenant de la même équipe.</strong>
					</h1>
				</c:if>

				<c:if test="${messageErreur.codeErreurOffreTrade==10}">
					<h1 style="color: red">
						<strong>Vous ne pouvez mettre plus de 3 draft pick provenant de la meme equipe.</strong>
					</h1>
				</c:if>

				<c:if test="${messageErreur.codeErreurOffreTrade==1}">
					<h1 style="color: red">
						<strong>Une des 2 équipes se retrouve avec plus de 12 contrats. Reglement 2.1</strong>
					</h1>
				</c:if>

				<c:if test="${messageErreur.codeErreurOffreTrade==2}">
					<h1 style="color: red">
						<strong>Une des 2 équipes se retrouve avec pas assez d'argent pour compléter son draft. Reglement 2.4</strong>
					</h1>
				</c:if>
				...
				<button style="font-size: 28px" onclick="onNewOfferButtonClick()">Faire une nouvelle offre</button>
			</div>
