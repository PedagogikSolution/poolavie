...
<body>
	...
	<div class="w3-container">
		...
		<c:if test="${requestScope.tradeOpen==1}">
			...
			<c:if test="${Pool.nomTeam9!=null}"><form class="w3-left" method="post" action="/Trade">
			<input type="hidden" name="tradeWith" value="9">
			<input type="hidden" name="tradeTag" value="1">
			<input type="submit" value="${Pool.nomTeam9}"/>
			</form></c:if>
			<c:if test="${Pool.nomTeam10!=null}"><form class="w3-left" method="post" action="/Trade">
			<input type="hidden" name="tradeWith" value="10">
			<input type="hidden" name="tradeTag" value="1">
			<input type="submit" value="${Pool.nomTeam10}"/>
			</form></c:if>
			<c:if test="${Pool.nomTeam11!=null}"><form class="w3-left" method="post" action="/Trade">
			<input type="hidden" name="tradeWith" value="11">
			<input type="hidden" name="tradeTag" value="1">
			<input type="submit" value="${Pool.nomTeam11}"/>
			</form></c:if>
			<c:if test="${Pool.nomTeam12!=null}"><form class="w3-left" method="post" action="/Trade">
