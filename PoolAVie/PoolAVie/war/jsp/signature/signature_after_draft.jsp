...
<body>
	...
	<div class="main_container">
		...
		<div id="main_content_title_classement">Signature des joueurs après le draft</div>
		<div id="main_content_table_classement">
			...
			<c:choose>
					...
					<table>
						...
						<c:forEach var="i" begin="0" end="${fn:length(longueur)-1}">
							...
							<tr>
								...
								<td>
								<input form="signatureAbform${i}" type="radio" name="nombre_annee" value="2">
								</td>
								<td>
								<input form="signatureAbform${i}" type="radio" name="nombre_annee" value="3">
								</td>
								<td>
								<input form="signatureAbform${i}" type="radio" name="nombre_annee" value="4">
								</td>
								<td>
								<input form="signatureAbform${i}" type="radio" name="nombre_annee" value="5">
								</td>
								<td>	<form id="signatureAbform${i}" action="/signatureAfterDraft" method="post">
										...
										<input type="hidden" value="signatureADverif" name="signatureAfterDraft" />
				...
				<c:otherwise>
				Vous n'avez pas de joueurs pouvant être signé apres le draft
