...
<body>
	...
	<div class="main_container">
		...
		<div id="main_content_table_classement">
			...
			<h1>Vous voulez monter : ${monterRookie.nomDuJoueur}</h1>
			<br>
			<h1>et le signer pour ${monterRookie.nombreAnnee} ans</h1>
			<br>
			<h1>pour la somme de  ${monterRookie.salaire} par année</h1>
			...
			<form action="/rookieFin" method="post">
				<input type="hidden" value="monter" name="rookieFin_type" />
				<input type="hidden" value="${monterRookie.joueurId}" name="player_id" />
				<input type="hidden" value="${monterRookie.nombreAnnee}" name="nombre_annee" />
				<input type="hidden" value="${monterRookie.salaire}" name="salaire" />
				<input style="font-size: 18px" type="submit" value="Oui et il est mieux de performer criss">
			</form>

			<form action="/rookieFin" method="post">
				<input type="hidden" value="nePasMonter" name="rookieFin_type" />
				<input style="font-size: 18px" type="submit" value="Qu'il reste dans les mineur ce petit con">
			</form>
