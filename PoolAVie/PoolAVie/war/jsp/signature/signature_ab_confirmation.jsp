...
<body>
	...
	<div class="main_container">
		...
		<p>Voulez-vous vraiment signé ${information_signature.nomDuJoueur} au salaire de ${information_signature.montant} pour ${information_signature.nombreAnnee} ans supplémentaire</p>
		
		
		<form action="/signatureAB" method="post">
		<input type="hidden" value="confirmationSignatureAB" name="signatureAB"/>
		...
		<input type="hidden" value="${information_signature.moyenne}" name="moyenne"/>
		<input type="hidden" value="${information_signature.nombreAnnee}" name="nombreAnnee"/>
		<input type="submit" value="Oui">
		</form>
		
		<form action="/signatureAB" method="post">
		<input type="hidden" value="annulationSignatureAB" name="signatureAB"/>
