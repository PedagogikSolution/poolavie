...
public class DetailTradeCompleteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		rs = recupOffer.recuperationMyTradeShowDetail(trade_id);
		...
		req.getRequestDispatcher("/jsp/trade/old_show_offer.jsp").forward(req, resp);
	}
