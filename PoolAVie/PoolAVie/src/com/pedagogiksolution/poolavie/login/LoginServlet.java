...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		// recup�ration des input du formulaire de login
		username = req.getParameter("user");
		password = req.getParameter("password");

		// connexion aux serveurs de base de donn�e
		...
		if (conn != null) {
			...
			// 
			/* r�cup�ration des informations selon le username */
			try {
				...
				try {
					...
					if (rs != null) {
						if (rs.next()) {
							...
							/*
							 * si recup�ration ok, testing du password sur le
							 * username
							 */
							rs.close();
							try {
