...
public class EquipesServlet extends HttpServlet {
    ...
    int max_salaire, total_salaire, budget_restant, moy_restante, nb_att, nb_def, nb_gar, nb_rook, nb_contrat, nb_equipe, manq_equipe, manq_att, manq_def, manq_gar, manq_rook,
	...
	statement4 = "SELECT * FROM players WHERE players.club_ecole='1' AND players.team_id='" + teamIdentifiant + "' ORDER BY pts DESC";
	statement5 = "SELECT * FROM equipes WHERE team_id='" + teamIdentifiant + "'";
