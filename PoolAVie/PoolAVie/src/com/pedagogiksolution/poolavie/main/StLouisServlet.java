...
public class StLouisServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		// connexion aux serveurs4 de base de donn�e
		dbHelper = new DatabaseConnector();
		conn = dbHelper.open();
		// si connexion est bonne on r�cup�re les informations de la table
		// utilisateur
		if (conn != null) {

			try {
				/* r�cup�ration des informations selon le identifiant equipe */
				statement = "SELECT * FROM players WHERE players.position='attaquant' AND players.club_ecole='0' AND players.team_id=7 ORDER BY pts DESC";
				statement2 = "SELECT * FROM players WHERE players.position='defenseur' AND players.club_ecole='0' AND players.team_id=7 ORDER BY pts DESC";
				statement3 = "SELECT * FROM players WHERE players.position='gardien' AND players.club_ecole='0' AND players.team_id=7 ORDER BY pts DESC";
				statement4 = "SELECT * FROM players WHERE players.club_ecole='1' AND players.team_id=7 ORDER BY pts DESC";
				statement5 = "SELECT * FROM equipes WHERE team_id=7";
				try {
					...
					ResultSet rs9 = recupTeam.recuperationPick(7);
					...
					req.getRequestDispatcher("/jsp/equipes/st_louis.jsp").forward(
							req, resp);
			...
			// une erreur de connexion s'est produite, g�rer ce probl�me pour
