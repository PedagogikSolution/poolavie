	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (conn != null) {
			...
			try {
				...
				statement = "SELECT * FROM players WHERE players.position='attaquant' AND players.club_ecole='0' AND players.team_id=8";
				statement2 = "SELECT * FROM players WHERE players.position='defenseur' AND players.club_ecole='0' AND players.team_id=8";
				statement3 = "SELECT * FROM players WHERE players.position='gardien' AND players.club_ecole='0' AND players.team_id=8";
				statement4 = "SELECT * FROM players WHERE players.club_ecole='1' AND players.team_id=8";
