...
public class FredServlet extends HttpServlet {
	/**
	 * 
	 */
...
// ligbne bidon
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (conn != null) {
			...
			try {
				...
				statement = "SELECT * FROM players WHERE players.position='attaquant' AND players.club_ecole='0' AND players.team_id=11 ORDER BY pts DESC";
				statement2 = "SELECT * FROM players WHERE players.position='defenseur' AND players.club_ecole='0' AND players.team_id=11 ORDER BY pts DESC";
				statement3 = "SELECT * FROM players WHERE players.position='gardien' AND players.club_ecole='0' AND players.team_id=11 ORDER BY pts DESC";
				statement4 = "SELECT * FROM players WHERE players.club_ecole='1' AND players.team_id=11 ORDER BY pts DESC";
				statement5 = "SELECT * FROM equipes WHERE team_id=11";
				try {
	...
	rs5.close();
					...
					ResultSet rs9 = recupTeam.recuperationPick(11);
					...
					req.getRequestDispatcher("/jsp/equipes/fred.jsp").forward(
							req, resp);
