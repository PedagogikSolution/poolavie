...
public class MessageErreurConstants {
    ...
    public static String LOGIN_PASSWORD_NOT_GOOD = "Mauvais mot de passe. Veuillez ré-essayer. Cliquez ci-bas si vous avez oublié votre mot de passe";
    public static String RECUPERATION_COURRIEL_INEXISTANT = "Ce courriel n'est associé à aucun compte";
    public static String NOT_LOG_IN ="Vous devez être connecté pour accéder � cette section. Merci de vous connecter ci-bas";
