...
public interface TradeMadeDao {
    ...
    void insertTradeMade(int poolId, int trade_id, int cycleAnnuel)throws DAOException;
    ...
    TradeBeans showOfferX(Pool mBeanPool, Utilisateur mBeanUser, int trade_id, PlayersDao playersDao, DraftPickDao draftPickDao, DraftDao draftDao);
