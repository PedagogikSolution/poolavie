...
public class UpdatePlayersTemplateStatsCron2 extends HttpServlet {
	...
	//	String thisYearForApi = thisYear.replace("-", "");
		...
		String lastYear = "20232024";
		String twoYear = "20222023";
		...
		idList=mBeanPlayersId.getPlayers_id();
			...
			queue.add(TaskOptions.Builder.withUrl("/TaskQueueUpdatePlayersStats2")
					.param("player_id", String.valueOf(idList.get(i))).param("lastYear", lastYear).param("twoYear", twoYear));
