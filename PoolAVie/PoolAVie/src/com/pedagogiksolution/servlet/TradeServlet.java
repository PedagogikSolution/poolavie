...
public class TradeServlet extends HttpServlet {
	...
	case 1:
	    ...
	    // on met a jour les objet de session pour etre certain d'avoir la plus recente representation des donn�es
...
// connecter d'aller directemetn a URL .jsp si pas bon cycle)
	    ...
	    // on test si recuperation des donn�es des deux equipes a jour fait , si oui on retourne message erreur a
// trade_center,
