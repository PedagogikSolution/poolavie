...
public class LoginModel {
	...
	public void resetConnexionOpen() {
		...
		try {
			Entity mEntityFromDatastore = datastore.get(mKey);
			
			
			mBeanDraftProcess.mapDatastoreToBean(mEntityFromDatastore,mBeanDraftProcess);
		...
		Entity mEntity = mBeanDraftProcess.mapBeanToEntityForDatastore(mBeanDraftProcess, poolID);
