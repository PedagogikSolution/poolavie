...
public class TaskQueueModel {
	...
	public void persistPlayer() {
		...
		if (isRookieId == 0) {
			...
			playersDao.persistPlayerPick(playersId, salaireId, poolId, teamId, clubEcoleId);
			...
			int yearsOfC = playersDao.checkIfPlayersWillHaveMoreThan25DuringContract(poolId, playersId);
			playersDao.persistPlayerPickRookie(playersId, salaireId, poolId, teamId, clubEcoleId, yearsOfC);
			PlayersCronModel mModel = new PlayersCronModel(playersDao);
