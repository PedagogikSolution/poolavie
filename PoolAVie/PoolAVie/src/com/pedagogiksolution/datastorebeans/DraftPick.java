...
public class DraftPick implements Serializable {
	...
	public DraftPick mapDraftPickFromDatastore(com.google.appengine.api.datastore.Entity mEntity,
			DraftPick mBeanDraftPick) {
	...
	public Entity mapBeanToEntityForDatastore(DraftPick mBean, String name) {

		Entity mEntity = new Entity("DraftPick", name);

		mEntity.setProperty("pick_no", mBean.getPick_no());

		mEntity.setProperty("original_pick_id", mBean.getOriginal_pick_id());

		mEntity.setProperty("total_pick_number", mBean.getTotal_pick_number());

		mEntity.setProperty("teamNameOriginalPick", mBean.getTeamNameOriginalPick());
